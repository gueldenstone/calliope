...
config :storyteller, StorytellerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "NB0r/l3yHUPCTydTgxHC2gjQjHD9mbXpe63vPqyzdR96IcGvC740+S8H01hR0SYe",
  watchers: [
...
config :storyteller, StorytellerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/storyteller_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :storyteller, dev_routes: true

defmodule StorytellerWeb.UserLiveTest do
  use StorytellerWeb.ConnCase

  import Phoenix.LiveViewTest
  import Storyteller.ProductsFixtures

  @create_attrs %{type: :number, pseudonym: "some pseudonym"}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated pseudonym"
    end
